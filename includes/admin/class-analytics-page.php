...
class PV_Analytics_Page {
	...
	public function render_page(): void {
		...
		$_cbtn = '<button class="pva-expand-btn" type="button" aria-label="' . esc_attr__( 'Focus this block', 'pv-youtube-importer' ) . '" style="display:none"><svg class="pva-expand-icon" width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M7 14H5v5h5v-2H7v-3zm-2-4h2V7h3V5H5v5zm12 7h-3v2h5v-5h-2v3zM14 5v2h3v3h2V5h-5z"/></svg></button>';
		?>
		...
		<div class="pva-inner">
			...
			<div class="pva-export-bar">
				...
				<!-- Copy Report button — shown only on YouTube tab -->
				<button id="pva-copy-report" type="button" hidden>
					<svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12V1zm3 4H8c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z"/></svg>
					<span><?php esc_html_e( 'Copy Report', 'pv-youtube-importer' ); ?></span>
				</button>
			</div><!-- .pva-export-bar -->
			...
			<div class="pva-stats-row">
				...
				<div class="pva-stat-card">
					<div class="pva-stat-icon pva-icon--viewers" aria-hidden="true">
					...
					<div class="pva-stat-body">
						<div class="pva-stat-value" id="pva-unique-viewers">—</div>
						<div class="pva-stat-label"><?php esc_html_e( 'Unique Viewers', 'pv-youtube-importer' ); ?></div>
						<div class="pva-stat-sublabel"><?php esc_html_e( 'Distinct sessions', 'pv-youtube-importer' ); ?></div>
					</div>
				</div>
