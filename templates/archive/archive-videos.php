	...
	<div class="pv-archive-content<?php echo $pv_hero_show ? '' : ' pv-archive-content--no-hero'; ?>"<?php echo $_pv_width_attr; // phpcs:ignore ?>>
		<div class="pv-archive-layout">
			...
			<?php if ( have_posts() ) : ?>
				...
				<div class="pv-search-escape" hidden>
					<button type="button" class="pv-pl-nav-back pv-search-back-btn">
						...
						<?php esc_html_e( 'Back to Latest', 'pv-youtube-importer' ); ?>
					</button>
				</div>
				...
				<div class="pv-broadcast">
					...
					<div class="pv-bc-search-escape" hidden>
						<button type="button" class="pv-pl-nav-back pv-bc-search-back-btn">
							<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"/></svg>
							<?php esc_html_e( 'Back to Latest', 'pv-youtube-importer' ); ?>
						</button>
					</div>
