<?php
/**
 * Watch Page Layout: Hero Split
 * Video left (~60%) / info panel right (~40%).
 *
...
<div class="pv-watch-page pv-watch-hero-split" style="--pv-accent:<?php echo esc_attr( $pv_accent ); ?>;">

	<div class="pv-watch-split-inner">

		<!-- Left: Video -->
		<div class="pv-watch-split-video">
			<?php if ( $pv_embed_url ) : ?>
			...
			<?php if ( $pv_watch_url ) : ?>
				<a href="<?php echo esc_url( $pv_watch_url ); ?>" class="pv-yt-link" target="_blank" rel="noopener">
		...
		<!-- Right: Info panel -->
		<div class="pv-watch-split-info">

			<div class="pv-watch-split-accent-bar" aria-hidden="true"></div>
