...
(function () {
	...
	function whenYtReady(fn) {
		ytApiReady ? fn() : ytApiQueue.push(fn);
	}
	...
	function showSpinner() {
		if (spinner) { spinner.removeAttribute('hidden'); spinner.style.display = ''; }
	}
