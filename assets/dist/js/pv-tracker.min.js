...
(function () {
	...
	function init() {
		...
		// Music player bridge — receives pv:track-event dispatched by music-mode.min.js
		document.addEventListener('pv:track-event', function (e) {
			if (e.detail && e.detail.youtubeId) {
				sendEvent(e.detail.event || 'play', e.detail.youtubeId);
			}
		});
