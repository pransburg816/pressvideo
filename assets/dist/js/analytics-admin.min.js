...
(function () {
	...
	var TIPS = {
		...
		'least-watched':'Videos with the fewest plays this period — your biggest opportunity. These are candidates for targeted promotion, a re-edited opening hook, or archiving if they consistently underperform.',
		...
		'insights':     'Automated signals detected from your analytics — traffic spikes, completion drop-offs, and trends worth your attention. These update each time your data refreshes.',
	...
	function initTooltips() {
		...
		document.addEventListener('click', function(e) {
			...
			if (btn) {
				...
				// Arrow offset
				var arrowLeft = (rect.left + scrollX + rect.width / 2) - left - 5;
	...
	function renderPerformanceInsights(data) {
		...
		col.innerHTML = '<div class="pv-card pva-insights-card">'
			+ '<div class="pv-card__head">'
	...
	function renderFeaturePicks(data) {
		...
		section.innerHTML = '<div class="pv-card">'
			+ '<div class="pv-card__head">'
	...
	function renderLeastWatched(data) {
		...
		col.innerHTML = '<div class="pv-card pva-least-card">'
			+ '<div class="pv-card__head">'
