...
(function () {
	...
	function switchToSite() {
		...
		// Move YouTube Performance card back into table row and restore 3-col layout.
	...
	function renderYtLeast(top) {
		...
		col.innerHTML = '<div class="pv-card pva-least-card" data-card-id="yt-retention">'
			+ '<div class="pv-card__head"><h2 class="pv-card__title">Lowest Retention</h2><span class="pva-chart-sub">Videos losing viewers earliest</span></div>'
			+ '<div class="pv-card__body pva-least__body">' + rows + '</div></div>';
	}
