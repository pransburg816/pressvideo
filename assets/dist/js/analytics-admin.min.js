...
(function () {
	...
	function renderYouTube(data) {
		...
		// Trend chart canvas
		var trendCard = '<div class="pv-card pva-yt-card" data-card-id="yt-trend">'
			+ '<div class="pv-card__head">'
		...
		var topCard = '<div class="pv-card pva-yt-card" data-card-id="yt-top-videos">'
			+ '<div class="pv-card__head">'
		...
		var engCard = '<div class="pv-card pva-yt-card" data-card-id="yt-engagement">'
			+ '<div class="pv-card__head">'
		...
		// Stat cards go in the top-level stat row, not inside the section.
		var ytStatsOuter = document.getElementById('pva-yt-stats-row');
		if (ytStatsOuter) ytStatsOuter.innerHTML = statCards;

		section.innerHTML = '<div class="pva-yt-grid">'
			+   trendCard
			+   topCard
			+   engCard
			+   tableCard
		...
		// Render YouTube-specific AI coach + insights
