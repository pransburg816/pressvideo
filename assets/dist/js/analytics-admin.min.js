...
(function () {
	...
	function switchToYouTube() {
		...
		// Always hide table row and clear least col before branching — prevents Site Stats
		// "Least Watched" content from bleeding into the YouTube tab on either path.
		if (tableRow) tableRow.hidden = true;
		var leastColEl = document.getElementById('pva-least-col');
		if (leastColEl) leastColEl.innerHTML = '';
