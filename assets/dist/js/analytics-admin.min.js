	...
	function renderInsights(data) {
		...
		if (picks.length) {
			...
			picksHtml = '<div class="pva-insights-section">'
				...
				+   '<p>These videos will drive the most engagement right now</p>'
				+ '</div>'
		...
		var insightsHtml = insights.length
			...
			+     '<p>Actionable signals from your last ' + activeDays + ' days</p>'
			+   '</div>'
