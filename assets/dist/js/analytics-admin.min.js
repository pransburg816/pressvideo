...
(function () {
	...
	function renderCoachTeaser(col) {
		col.innerHTML =
			'<div class="pv-card pva-coach-card">'
			+ '<div class="pv-card__head"><h2 class="pv-card__title">AI Growth Coach</h2>' + tipBtn('coach') + expandBtn() + '</div>'
			+ '<div class="pv-card__body pva-coach-teaser">'
			+ '<p class="pva-coach-teaser__intro">Once your videos are getting plays, AI Coach analyzes your real numbers and delivers 3 specific growth moves each day — each one targeting your weakest metric.</p>'
			+ '<ul class="pva-coach-teaser__list">'
			+ '<li>Which videos to promote this week based on momentum</li>'
			+ '<li>Where viewers are dropping off and a concrete hook fix</li>'
			+ '<li>What your top video\'s success tells you about your next one</li>'
			+ '</ul>'
			+ '<p class="pva-coach-teaser__cta">Ready when you are — start tracking plays by <a href="' + esc(cfg.settingsUrl || '') + '">adding your GA4 Measurement ID</a>.</p>'
			+ '</div>'
			+ '</div>';
	}
	...
	function expandBtn() {
		...
		return '<button class="pva-expand-btn" type="button" aria-label="Focus this block" style="display:none">'
	...
	function switchToYouTube() {
		...
		if (!cfg.ytConnected) {
			// Not connected: restore site stats bar as visual anchor
			if (statsRow)      statsRow.hidden      = false;
			if (ytStatsRow)    ytStatsRow.hidden    = true;
