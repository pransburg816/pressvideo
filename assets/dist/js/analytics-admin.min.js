...
(function () {
	...
	var DEMO_AI_MOVES = [
		...
		},
		{
			...
			edge:   'Your top 3 videos are capturing a disproportionate share of plays — your other 7 are effectively invisible to visitors who would genuinely want them.',
		...
		},
		{
			...
			edge:   'Your play trend is climbing — this is exactly the window most creators waste by going inconsistent right when the algorithm starts paying attention.',
	...
	function renderCoach(data) {
		...
		// Demo mode always shows sample AI moves so the preview reflects the real AI experience
		...
		var playbookSub   = aiMoves
			? ( demoMode ? 'Sample AI recommendations — your real insights will be based on your actual data' : 'Generated by Claude AI based on your real data' )
			...
			+   ( aiMoves
				? ( demoMode
					...
					: '<div class="pva-ai-status">'
						+ '<span class="pva-ai-status__dot"></span>'
						+ '<span class="pva-ai-status__text"><strong>Claude AI is active</strong>'
