...
(function () {
	...
	function switchToSite() {
		...
		// Swap date range controls: restore site pills, hide YouTube dropdown.
		var rangePillsSite = document.querySelector('.pva-range-pills');
		var ytRangeSite    = document.getElementById('pva-yt-range');
		if (rangePillsSite) rangePillsSite.hidden = false;
	...
	function switchToYouTube() {
		...
		// Swap date range controls: hide site pills, show YouTube dropdown.
		var rangePills = document.querySelector('.pva-range-pills');
		var ytRange    = document.getElementById('pva-yt-range');
		if (rangePills) rangePills.hidden = true;
