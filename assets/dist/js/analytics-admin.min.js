...
(function () {
	...
	function showNoDataState() {
		...
		// Always expose the integrations card so users can find the connect buttons
		if (aiRow)         aiRow.hidden         = false;
		if (insightsCol)   insightsCol.hidden    = true;
		if (intCol)        intCol.hidden         = false;

		// Show AI coach teaser when key is available but data hasn't arrived yet
		if (coachCol) {
			if (cfg.hasAiKey) {
				coachCol.hidden = false;
				renderCoachTeaser(coachCol);
			} else {
				coachCol.hidden = true;
			}
		}
		...
		// All Videos — show with an explanation instead of skeleton/hidden
		if (tableRow) {
		...
		// What to Feature — show with explanation
	...
	function switchToSite() {
		...
		// Restore insights col and hide integrations when returning to site tab.
		...
		// Re-render site coach/insights with site data.
	...
	function switchToYouTube() {
		...
		if (!cfg.ytConnected) {
			// Not connected: hide chart/table blocks, show placeholder.
