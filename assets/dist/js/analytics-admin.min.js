...
(function () {
	...
	function renderCoach(data) {
		...
		var aiMoves  = cfg.aiMoves && cfg.aiMoves.length ? cfg.aiMoves : null;
		...
		var coachSub = aiMoves
			? '<span class="pva-coach__ai-badge">'
		...
		var playbookSub   = aiMoves ? 'Generated by Claude AI based on your real data' : 'Data-driven scripts personalized to your content';
		...
		coachCol.innerHTML = '<div class="pv-card pva-coach">'
			...
			+   ( aiMoves
				? '<div class="pva-ai-status">'
					...
					+ '<span class="pva-ai-status__text">'
					+   '<strong>Claude AI is active</strong>'
