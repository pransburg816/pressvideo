...
(function () {
	...
	function render(data) {
		...
		// Auto-generate period-specific AI if not yet cached for this range
		if (!demoMode && cfg.hasAiKey && hasData && !cfg.sitePeriodSummaries[activeDays]) {
			refreshAiInsights();
		}
	}
	...
	function renderCoach(data) {
		...
		var playbookTitle = aiMoves ? 'Your AI-Powered Growth Playbook' : 'Your AI-Powered Growth Playbook';
	...
	function renderSummary(data) {
		...
		var sumSparkHtml = usedAiSummary
	...
	function renderYouTubeCoach(ytData) {
		...
		var playbookTitle = ytAiMoves ? 'Your AI-Powered YouTube Growth Playbook' : 'Your AI-Powered YouTube Growth Playbook';
