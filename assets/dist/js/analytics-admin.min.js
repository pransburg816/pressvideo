...
(function () {
	...
	function buildDemoData( days ) {
		...
		return {
			...
			trend:     { labels: lbls, values: vals, is_monthly: false },
	...
	function showLoading() {
		// Reset stat values
		['pva-total-plays', 'pva-unique-videos', 'pva-avg-completion', 'pva-engaged-plays'].forEach(function (id) {
	...
	function renderTable(allVideos) {
		...
		var rows = allVideos.map(function (v) {
			...
			var avgCell = avgComp > 0
				? '<span style="color:' + avgColor + ';font-weight:600">' + avgComp + '%</span>'
