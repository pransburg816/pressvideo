...
(function () {
	...
	function showNoDataState() {
		...
		// Show all three AI columns — never hide sections, show explanations instead
		if (aiRow) {
			aiRow.hidden = false;
			aiRow.classList.add('pva-ai-row--three-col');
		}
		if (coachCol) {
		...
		// All Videos + What to Feature side-by-side in the table row
		if (tableRow) {
			...
			if (leastCol) {
				leastCol.innerHTML = '<div class="pv-card" style="height:100%">'
					+ '<div class="pv-card__head"><h2 class="pv-card__title">What to Feature</h2>'
					+ '<span class="pva-chart-sub">Your top videos, ready to promote</span></div>'
					...
					+ '<p>Once your videos start getting plays, this section surfaces your top 3 performers and flags which ones deserve a promotion push. Videos with strong watch depth but lower play counts show up first — great content that\'s being under-served by distribution.</p>'
					+ '</div>'
					+ '</div>'
					+ '</div>';
			}
