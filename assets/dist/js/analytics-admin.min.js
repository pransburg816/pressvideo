...
(function () {
	...
	function generateReport(data) {
		...
		var depthCanvas = document.getElementById('pva-depth-chart');
		if (depthCanvas) depthImg = depthCanvas.toDataURL('image/png');
		...
		var html = '<!DOCTYPE html><html><head><meta charset="UTF-8">'
			...
			// Watch depth chart
			+   (depthImg ? '<div style="margin-bottom:32px;">'
			+     '<h2 style="font-size:1rem;font-weight:700;color:#1e293b;margin:0 0 4px;">Watch Depth Breakdown</h2>'
			+     '<p style="font-size:12px;color:#94a3b8;margin:0 0 10px;">How far viewers watch before dropping off. Engaged = hit 50%+.</p>'
			+     '<img src="' + depthImg + '" style="width:100%;max-width:400px;border:1px solid #e2e8f0;border-radius:10px;display:block;margin:0 auto;">'
			+   '</div>' : '')
